...
stock_symbols <- c("HDFCAMC.NS", "APOLLOHOSP.NS", "OFSS.NS", "LUPIN.NS", "INDHOTEL.NS", "TORNTPOWER.NS", 
                   ...
                   "ABFRL.NS", "SYNGENE.NS", "CRISIL.NS", "TATAINVEST.NS", "GODIGIT.NS","HDFCBANK.NS", 
                   "BHARTIARTL.NS", "ICICIBANK.NS", "INFY.NS", "HCLTECH.NS","SUNPHARMA.NS", "NTPC.NS", 
                   "KOTAKBANK.NS", "BAJAJ-AUTO.NS", "WIPRO.NS", "SIEMENS.NS", "TRENT.NS", "ZOMATO.NS",
                   "DLF.NS", "LTIM.NS","VEDL.NS", "ABB.NS", "INDIGO.NS", "TECHM.NS", "HINDALCO.NS", 
                   "DIVISLAB.NS", "HDFCLIFE.NS", "BPCL.NS", "GAIL.NS", "BRITANNIA.NS","MOTHERSON.NS", 
                   "BAJAJHLDNG.NS", "TORNTPHARM.NS", "UNITDSPR.NS", "BOSCHLTD.NS","NAUKRI.NS","RELIANCE.NS",
                    "LICI.NS", "TATAMOTORS.NS","ADANIPOWER.NS", "IRFC.NS", "TATASTEEL.NS", "AMBUJACEM.NS", 
                    "ADANIENSOL.NS", "LODHA.NS","TCS.NS","LT.NS","ONGC.NS","HAL.NS","TITAN.NS","ADANIPORTS.NS",
                     "ASIANPAINT.NS","DMART.NS","IOC.NS","NESTLEIND.NS","GODREJCP.NS","TATACONSUM.NS","ZYDUSLIFE.NS","DABUR.NS")
